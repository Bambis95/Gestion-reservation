...
class Home:
    def __init__(self, root):
        ...
        client = Button(self.root, text="Client",command=self.page_client ,font=("times new roman", 15,"bold"), bd=0, activebackground=background, bg=background, cursor="hand2").place(x=10, y=10)
        reservation = Button(self.root, text="Reservation",command=self.page_reservation ,font=("times new roman", 15,"bold"), bd=0, activebackground=background, bg=background, cursor="hand2").place(x=100, y=10)
        plainte = Button(self.root, text="Plainte",command=self.page_plainte, font=("times new roman", 15,"bold"), bd=0, activebackground=background, bg=background, cursor="hand2").place(x=230, y=10)
    ...
    def deconnecte(self):
        self.root.destroy()
        os.system("python C:/Users/uthma/OneDrive/TopSecret/Mes_Mini_Projet/Gestion_Reservation/login.py")
